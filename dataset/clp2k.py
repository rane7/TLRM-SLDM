...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        elif self.dataset_mode == 'clp2k':
            arr_class = arr_class - 1
            arr_class[arr_class == 255] = 14
        ...
        return np.transpose(arr_image, [2, 0, 1]), out_dict, file_name
